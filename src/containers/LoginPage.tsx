...
function LoginPage() {
  return (
    <div className="h-[1000px] md:h-screen w-screen flex flex-col md:flex-row justify-center items-center m-0 p-0">
      <div className="h-[60%] md:h-full w-full md:w-[45%] flex flex-col justify-center items-center md:items-start m-0 py-0 pr-0 pl-0 md:pl-[50px] lg:pl-[75px] bg-color-three">
        <Logo position="absolute" show="block" />
        <h1 className="text-white font-bold text-[30px] lg:text-[40px] text-left">
      ...
      <div className="h-[35%] md:h-full w-full md:w-[45%] flex flex-col justify-between md:justify-end items-start m-0 pt-0 pb-[175px] md:pb-[375px] lg:pb-[175px] px-[30px] lg:px-[75px] bg-color-six">
        <Circles />
        ...
        <form className="h-[30%] lg:h-[42%] w-full flex flex-col justify-center lg:justify-evenly items-start">
          ...
          <div className="h-1/5 w-full flex flex-row justify-center md:justify-start items-start lg:items-center mt-[40px] mb-0 mx-0 p-0">
            <input
              type="submit"
              value="Login"
              className="w-full text-white font-medium bg-color-three m-0 py-[13px] px-[45px] border-0 rounded-[10px] hover:cursor-pointer hover:bg-color-three-9"
            />
          </div>
        </form>
      </div>
