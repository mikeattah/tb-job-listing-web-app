    ...
    <div className="h-[150px] md:h-[80px] w-full mt-[-40px] mb-0 py-0 pl-[25px] md:pl-[75px] lg:pl-[125px] pr-[25px] md:pr-[50px] lg:pr-[75px] z-10">
      <div className="h-full w-full flex flex-col md:flex-row justify-evenly md:justify-between items-center m-0 py-0 px-[20px] rounded-lg bg-white shadow-aaa">
        <input
          ...
          className="h-[25%] md:h-1/2 w-full md:w-1/2 m-0 py-2 px-3 outline-0 border-[0.3px] md:border-none border-color-one rounded-lg shadow-none text-center md:text-left"
        />
        ...
        <input
          ...
          className="h-[25%] md:h-1/2 w-full md:w-[42%] m-0 py-2 px-3 outline-0 border-[0.3px] md:border-none border-color-one rounded-lg shadow-none text-center md:text-left"
        />
        <input
          type="submit"
          id="submit-search"
